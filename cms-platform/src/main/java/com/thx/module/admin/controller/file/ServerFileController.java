...
import com.thx.module.admin.util.HttpStreamProxyUtil;
import com.thx.common.vo.PageResultVo;
...
public class ServerFileController {
    ...
    public void download(String id, HttpServletRequest request, HttpServletResponse response) {
        ...
        Long size = record != null ? record.getSize() : null;
        HttpStreamProxyUtil.proxyDownload(url, response, fileName, contentType, size);
    }
