...
import com.thx.common.shiro.filter.AnnoOrLoginFilter;
import com.thx.common.shiro.filter.KickoutSessionControlFilter;
...
public class ShiroConfig {
    ...
    public void init() {
        log.info("========================================");
        log.info("Shiro 配置信息:");
        log.info("缓存类型 (cacheType): {}", cacheType);
        log.info("是否使用 Redis: {}", cacheType == CacheType.REDIS);
        log.info("Redis 主机: {}", redisProperties.getHost());
        log.info("Redis 端口: {}", redisProperties.getPort());
        log.info("Redis 数据库: {}", redisProperties.getDatabase());
        log.info("Session Key 前缀: {}", CoreConst.SHIRO_REDIS_SESSION_PREFIX);
        log.info("========================================");
    }
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        //自定义注解跳过登录访问
        filtersMap.put("annoOrLogin", new AnnoOrLoginFilter());
